        ...
        <q-card>
          <div class="row q-pa-md">
            ...
            <div class="col-8 q-pa-sm">
              <div class="text-weight-bold">{{ ssg.name }}</div>
              <div class="text-caption">{{ ssg.idNum }}</div>
              <div class="text-caption">{{ ssg.course }}, {{ ssg.year_admitted }}</div>

              <div class="text-caption">{{ ssg.department }}</div>
            </div>
          </div>
          <q-separator />
          <div class="row q-pa-md">Information to be added..</div>
        </q-card>
      </div>
      <div class="col-12 col-md-4 q-pt-xl gt-sm">
        <q-img src="~assets/images/profile.svg" />
      </div>
    </div>
  </q-page>
</template>
